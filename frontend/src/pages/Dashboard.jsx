...
const tabs = [
  ...
  { id: "history", label: "History", icon: HistoryIcon, color: "text-gray-500" },
];

const components = { explain: Explainer, summarize: Summarizer, quiz: QuizGenerator, flashcards: Flashcards, history: History };
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        {/* Tab Bar */}
        <div className="flex gap-1 bg-gray-100 dark:bg-gray-900 p-1 rounded-2xl mb-6 overflow-x-auto no-scrollbar">
