...
async def summarize_notes(
    ...
    style_map = {
        "bullets": "Summarize as clear, well-organized bullet points grouped by topic.",
        "paragraph": "Summarize as a concise, well-written paragraph.",
...
[
  {{
    ...
    text = ask_ai(prompt, max_tokens=3000)
    try:
...
[
  {{
    ...
    text = ask_ai(prompt, max_tokens=2000)
    try:
